...
export class SecondComponentComponent {
  ...
  array = [{
    text1: "caparezza meme 1",
    text2: "caparezza ti osserva minaccioso perchè vuole tutti i tuoi soldi"
  },
  {
    text3: "caparezza meme 2",
    text4: "caparezza ti osserva minaccioso perchè vuole il tuo pranzo"
  }]
